...
echo "Commit this detector into git: bash \"$PROJECT_ROOT/scripts/publish_trained_model.sh\""
echo "  (optional) GIT_PUSH=1 bash \"$PROJECT_ROOT/scripts/publish_trained_model.sh\""
