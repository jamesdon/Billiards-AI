...
Billiards-AI/
  ...
  scripts/
    ...
    calib_click.py                  Interactive live TL/TR/BL/BR corner picker with stronger corner/side-pocket auto-seeding, auto-scaled unclipped overlay, Fine/Coarse step radios (default Fine), camera radios (CSI/USB), writes calibration.json
