...
Billiards-AI/
  docs/
    ...
    4 Classification and identity.md  Optional **§4** reference (mirrors the six-line wizard step); wizard is canonical; `/api/setup/profiles-*`
