...
Billiards-AI/
  docs/
    ...
    TEST_PLAN.md                    §1–§9 delivery gates; **§4** points to `docs/4` **Workflow: start → success**
    4 Classification and identity.md  **§4** runbook: phases **A–F** (preconditions through sign-off), decision table, `identities.json` + GET/PATCH `/profiles`
