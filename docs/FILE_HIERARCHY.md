...
Billiards-AI/
  docs/
    ...
    4 Classification and identity.md  Optional **§4** reference; canonical runbook is setup wizard `phase4` + `/api/setup/profiles-*`
