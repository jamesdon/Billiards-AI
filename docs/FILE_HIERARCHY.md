...
Billiards-AI/
  docs/
    ...
    TEST_PLAN.md                    §1–§9 delivery gates; **§4** primary path is **`/setup`** Classification and identity (optional `docs/4` mirror)
    4 Classification and identity.md  Optional **§4** reference (mirrors the five-line wizard); wizard is canonical; `/api/setup/profiles-*`
