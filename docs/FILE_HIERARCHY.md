...
Billiards-AI/
  ...
  scripts/
    ...
    phase3.sh                       Detection/tracking verification sweep (n=1/2/3); fixed MJPEG **8001** / **8004** / **8005** (`PHASE3_PORT_*`); preflight: exit if any of those ports are already listening (e.g. manual `edge` still on 8001); stderr progress while waiting for `/mjpeg` (`PHASE3_MJPEG_WAIT_SECONDS`, default 90s)
